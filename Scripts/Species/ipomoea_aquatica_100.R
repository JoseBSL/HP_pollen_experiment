...
ipaq_seed_set_bind <- filter(ipaq_seed_set_bind, percentage!="50%")
...
ipaq_seed_set_final$Family[ipaq_seed_set_final$Treatment=="BROL 100%"] <- "Brassicaceae"
ipaq_seed_set_final$Family[ipaq_seed_set_final$Treatment=="BRRA 100%"] <- "Brassicaceae"
ipaq_seed_set_final$Family[ipaq_seed_set_final$Treatment=="SIAL 100%"] <- "Brassicaceae"
ipaq_seed_set_final$Family[ipaq_seed_set_final$Treatment=="ERSA 100%"] <- "Brassicaceae"
ipaq_seed_set_final$Family[ipaq_seed_set_final$Treatment=="CAAN 100%"] <- "Solanaceae"
ipaq_seed_set_final$Family[ipaq_seed_set_final$Treatment=="SOLY 100%"] <- "Solanaceae"
ipaq_seed_set_final$Family[ipaq_seed_set_final$Treatment=="SOME 100%"] <- "Solanaceae"
ipaq_seed_set_final$Family[ipaq_seed_set_final$Treatment=="PEIN 100%"] <- "Solanaceae"
ipaq_seed_set_final$Family[ipaq_seed_set_final$Treatment=="IPPU 100%"] <- "Convolvulaceae"
ipaq_seed_set_final$Family[ipaq_seed_set_final$Treatment=="IPAQ 100%"] <- "Convolvulaceae"
...
write.csv(ipaq_seed_set_final, "Rmd/Data/ipaq_seed_set_100.csv")
