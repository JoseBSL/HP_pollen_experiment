...
soly_seed_set_final$Treatment[soly_seed_set_final$Treatment=="BROL 50%"] <- "Wild cabbage"
soly_seed_set_final$Treatment[soly_seed_set_final$Treatment=="BRRA 50%"] <- "Pak choi"
soly_seed_set_final$Treatment[soly_seed_set_final$Treatment=="CAAN 50%"] <- "Capsicum"
soly_seed_set_final$Treatment[soly_seed_set_final$Treatment=="ERSA 50%"] <- "Rocket" #Eruca sativa seems to be a synonym
soly_seed_set_final$Treatment[soly_seed_set_final$Treatment=="IPAQ 50%"] <- "Water morning glory"
soly_seed_set_final$Treatment[soly_seed_set_final$Treatment=="IPPU 50%"] <- "Morning glory"
soly_seed_set_final$Treatment[soly_seed_set_final$Treatment=="PEIN 50%"] <- "Petunia"
soly_seed_set_final$Treatment[soly_seed_set_final$Treatment=="SIAL 50%"] <- "White mustard"
soly_seed_set_final$Treatment[soly_seed_set_final$Treatment=="SOLY 50%"] <- "Tomato"
soly_seed_set_final$Treatment[soly_seed_set_final$Treatment=="SOME 50%"] <- "Eggplant"
...
write.csv(soly_seed_set_final, "Rmd/Data/soly_seed_set_final_common_names.csv")
