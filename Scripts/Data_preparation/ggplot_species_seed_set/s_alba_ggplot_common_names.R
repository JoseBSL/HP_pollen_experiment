...
sial_seed_set_final$Treatment[sial_seed_set_final$Treatment=="BROL 50%"] <- "Wild cabbage"
sial_seed_set_final$Treatment[sial_seed_set_final$Treatment=="BRRA 50%"] <- "Pak choi"
sial_seed_set_final$Treatment[sial_seed_set_final$Treatment=="CAAN 50%"] <- "Capsicum"
sial_seed_set_final$Treatment[sial_seed_set_final$Treatment=="ERSA 50%"] <- "Rocket" #Eruca sativa seems to be a synonym
sial_seed_set_final$Treatment[sial_seed_set_final$Treatment=="IPAQ 50%"] <- "Water morning glory"
sial_seed_set_final$Treatment[sial_seed_set_final$Treatment=="IPPU 50%"] <- "Morning glory"
sial_seed_set_final$Treatment[sial_seed_set_final$Treatment=="PEIN 50%"] <- "Petunia"
sial_seed_set_final$Treatment[sial_seed_set_final$Treatment=="SIAL 50%"] <- "White mustard"
sial_seed_set_final$Treatment[sial_seed_set_final$Treatment=="SOLY 50%"] <- "Tomato"
sial_seed_set_final$Treatment[sial_seed_set_final$Treatment=="SOME 50%"] <- "Eggplant"
...
write.csv(sial_seed_set_final, "Rmd/Data/sial_seed_set_final_common_names.csv")
