...
ggplot(pollen_ratios_brassicaceae, aes(x=spp, y=ratio, fill=variable)) +
  geom_bar(stat='identity', position='dodge') +labs(title="Brassicaceae") + theme(axis.text.x=element_text(angle=60,hjust=1))
...
ggplot(pollen_ratios_solanaceae, aes(x=spp, y=ratio, fill=variable)) +
  geom_bar(stat='identity', position='dodge') +labs(title="Solanaceae") + theme(axis.text.x=element_text(angle=60,hjust=1))
...
ggplot(pollen_ratios_convolvulaceae, aes(x=spp, y=ratio, fill=variable)) +
  geom_bar(stat='identity', position='dodge') +labs(title="Convolvulaceae") + theme(axis.text.x=element_text(angle=60,hjust=1))
