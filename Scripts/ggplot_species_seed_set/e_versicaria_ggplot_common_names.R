...
ersa_seed_set_final$Treatment[ersa_seed_set_final$Treatment=="BROL 50%"] <- "Wild cabage"
ersa_seed_set_final$Treatment[ersa_seed_set_final$Treatment=="BRRA 50%"] <- "Pak choi"
ersa_seed_set_final$Treatment[ersa_seed_set_final$Treatment=="CAAN 50%"] <- "Capsicum"
ersa_seed_set_final$Treatment[ersa_seed_set_final$Treatment=="ERSA 50%"] <- "Rocket" #Eruca sativa seems to be a synonym
ersa_seed_set_final$Treatment[ersa_seed_set_final$Treatment=="IPAQ 50%"] <- "Water morning glory"
ersa_seed_set_final$Treatment[ersa_seed_set_final$Treatment=="IPPU 50%"] <- "Morning glory"
ersa_seed_set_final$Treatment[ersa_seed_set_final$Treatment=="PEIN 50%"] <- "Petunia"
ersa_seed_set_final$Treatment[ersa_seed_set_final$Treatment=="SIAL 50%"] <- "White mustard"
ersa_seed_set_final$Treatment[ersa_seed_set_final$Treatment=="SOLY 50%"] <- "Tomato"
ersa_seed_set_final$Treatment[ersa_seed_set_final$Treatment=="SOME 50%"] <- "Eggplant"
...
write.csv(ersa_seed_set_final, "Rmd/Data/ersa_seed_set_final_common_names.csv")
