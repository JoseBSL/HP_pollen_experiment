...
some_seed_set_final$Treatment[some_seed_set_final$Treatment=="BROL 50%"] <- "Wild cabbage"
some_seed_set_final$Treatment[some_seed_set_final$Treatment=="BRRA 50%"] <- "Pak choi"
some_seed_set_final$Treatment[some_seed_set_final$Treatment=="CAAN 50%"] <- "Capsicum"
some_seed_set_final$Treatment[some_seed_set_final$Treatment=="ERSA 50%"] <- "Rocket" #Eruca sativa seems to be a synonym
some_seed_set_final$Treatment[some_seed_set_final$Treatment=="IPAQ 50%"] <- "Water morning glory"
some_seed_set_final$Treatment[some_seed_set_final$Treatment=="IPPU 50%"] <- "Morning glory"
some_seed_set_final$Treatment[some_seed_set_final$Treatment=="PEIN 50%"] <- "Petunia"
some_seed_set_final$Treatment[some_seed_set_final$Treatment=="SIAL 50%"] <- "White mustard"
some_seed_set_final$Treatment[some_seed_set_final$Treatment=="SOLY 50%"] <- "Tomato"
some_seed_set_final$Treatment[some_seed_set_final$Treatment=="SOME 50%"] <- "Eggplant"
...
write.csv(some_seed_set_final, "Rmd/Data/some_seed_set_final_common_names.csv")
