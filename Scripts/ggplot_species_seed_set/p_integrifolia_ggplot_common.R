...
pein_seed_set_final$Treatment[pein_seed_set_final$Treatment=="BROL 50%"] <- "Wild cabbage"
pein_seed_set_final$Treatment[pein_seed_set_final$Treatment=="BRRA 50%"] <- "Pak choi"
pein_seed_set_final$Treatment[pein_seed_set_final$Treatment=="CAAN 50%"] <- "Capsicum"
pein_seed_set_final$Treatment[pein_seed_set_final$Treatment=="ERSA 50%"] <- "Rocket" #Eruca sativa seems to be a synonym
pein_seed_set_final$Treatment[pein_seed_set_final$Treatment=="IPAQ 50%"] <- "Water morning glory"
pein_seed_set_final$Treatment[pein_seed_set_final$Treatment=="IPPU 50 %"] <- "Morning glory"
pein_seed_set_final$Treatment[pein_seed_set_final$Treatment=="PEIN 50%"] <- "Petunia"
pein_seed_set_final$Treatment[pein_seed_set_final$Treatment=="SIAL 50%"] <- "White mustard"
pein_seed_set_final$Treatment[pein_seed_set_final$Treatment=="SOLY 50%"] <- "Tomato"
pein_seed_set_final$Treatment[pein_seed_set_final$Treatment=="SOME 50%"] <- "Eggplant"
...
write.csv(pein_seed_set_final, "Rmd/Data/pein_seed_set_final_common_names.csv")
