...
p1<-ggplot(pro_dat,aes(x=traits,y=pro_cor))+
  geom_bar(stat="identity",position="dodge")+theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank())
p2<-ggplot(pro_dat,aes(x=traits,y=sum_squ))+
  geom_bar(stat="identity",position="dodge")+theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank())
p3<-ggplot(pro_dat,aes(x=traits,y=signif))+
...
p1<-ggplot(pro_dat_sol,aes(x=traits_sol,y=pro_cor_sol))+
  geom_bar(stat="identity",position="dodge")+theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank())
p2<-ggplot(pro_dat_sol,aes(x=traits_sol,y=sum_squ_sol))+
  geom_bar(stat="identity",position="dodge")+theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank())
p3<-ggplot(pro_dat_sol,aes(x=traits_sol,y=signif_sol))+
  geom_bar(stat="identity",position="dodge")+theme(axis.text.x=element_text(angle=60,hjust=1))
