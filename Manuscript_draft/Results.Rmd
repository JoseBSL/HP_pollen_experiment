...
plot(its_distance$value, scaled_effect$value, main="Hp effect & evolutive distance", 
     xlab="Pairwise evolutive distances", ylab="Hp effect (Scaled seed set)", pch=19, col=scaled_effect$col_focal)
