...
\newpage
Now I use non metric multidimensional scaling for all the traits of our species. The traits used are: Stigma_type, Selfing_rate, Pollem_size, Mean_pollen_anther, Mean_ovules, Pollen_ovule_ratio, Anthers, Stigma_length, Stigma_surface (width), Style_length, Style_width, Ovary_width, Ovary_length
