...
Matrices of heterospecifc pollen effect and traits (Distance matrix of traits, euclidean distance) are positively and significantly correlated (r=0.4, one-tailed Mantel test p<0.05).The variable with maximum rank correlation (thorugh *Bioenv* funtion) was incompatibility index by itself within a group of 16 variables calculated with euclidean distances. 

[Add Bioenv results](Jose)

The same analysis of Mantel test between HP pollen effect and the traits one by one gave a positive and significant correlation for stigma type and stigma measurements (length, width and area). When the effect of heterospecific pollen was looked at family level, for Solanaceae species we found a strong negative non significant correlation between style length and heterospecific pollen effect (Pearson's correlation=0.93, p=0.07) (see **Figure 7**). 
