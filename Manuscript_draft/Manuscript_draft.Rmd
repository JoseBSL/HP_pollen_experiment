...
In natural systems plant species normally coexist and share their floral visitors with other species (Bascompte et al., 2003). This pollinator sharing from the plant perpective can be negative due to competition (refs) or positive due to facilitation (refs). Moreover, once the pollinator has landed on the stigma some other issues for the species fitness may arise, the arrival of foreign pollen and conspecific pollen loss. 

**Paragraph 2**

The effect of heterospecific pollen has been widely studied (refs). Native species are supposed to have greater negative effects than native ones @arceo2016. However, the quantity of pollen that integrates in the network can be quite low @bartomeus2008. Moreover, closely related species are supposed to reduce fitness in greter effect but the evidence is scarce and based on independent studies with different methodlogies (refs) or studies that just check that with very highly close related species with the aim of study hybridization (refs).    
