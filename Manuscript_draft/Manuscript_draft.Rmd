...
```{r, echo=FALSE,fig.align='center',message=FALSE, warning=FALSE, cache=FALSE, fig.height=3,fig.width=5,fig.cap="a"}
...
```{r, echo=FALSE, message=FALSE,fig.height=10,fig.width=5, warning=FALSE,fig.cap="Pollen ratios separated by family A) Brassicaceae, B) Solanaceae, C) Convolvulaceae. Pollen was counted for crosses with species of the other two families (N=3). To prepare these ratios all the pollen grains on the stigma were counted.", cache=FALSE}
