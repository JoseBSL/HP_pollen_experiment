...
considered pollen size and pollen allelopathy could be the two main
predictors of effect. How pollen size and allepothaty are involved in
heterospecific pollen effect remains unclear yet. For example, Herrera
...
which add another layer of complexity to the understanding of the
overall importance of this trait. Moreover, pollen allelopathy is still
an unclear field for pollination ecologist. When the pollen recipeint is
taking into account style length, stigmatic area, flower morphology,
number of ovules and incompatibility system seems to be the main
predictors of effect. In the case of style length species with shorter
styles will have greater heterospecific pollen effect due to pollen
competition is more likely to occur and therefore ovule interference.
Interestingly, differences of heterospecific pollen load has been shown
to do not be influenced by flowr morphology (restricted or
unrestricted), and the main predictor of the heterospecific pollen load
was stigma size (REF). Therefore, if bigger stigmas can receive more hp
pollen, a greater quantity of hp can be translated in a possible greater
negative effect. For species that are self-incompatible have stronger
barriers to heterospecific pollen than self-compatible species Ashman
and Arceo-Gómez (2013). Nonetheless, an effect of foreign pollen is a
bit obscured by the variability within species, however species that are
