...
the case, among these possible flower visitors we find also nectar
robbers and pollen thiefs (Refs) and the quality of pollen that is
deposited on the stigma is also highly relevant to the pollination
succes (Refs). Moreover, other less studies issues in the pollination
process are conspecific pollen loss and the arrival of foreign pollen
which can have important detrimental effects for the species fitness
