...
{\centering \includegraphics{output/figures/unnamed-chunk-8-1} 

}

\caption{a}\label{fig:unnamed-chunk-8}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{output/figures/unnamed-chunk-10-1.pdf}
\caption{Pollen ratios separated by family A) Brassicaceae, B)
Solanaceae, C) Convolvulaceae. Pollen was counted for crosses with
species of the other two families (N=3). To prepare these ratios all the
pollen grains on the stigma were counted.}
\end{figure}
