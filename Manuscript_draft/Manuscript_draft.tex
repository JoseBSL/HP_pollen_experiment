...
(2016); Fang and Huang (2013). The relatedness of foreign pollen gives a
first snapshoot of where the pollen competition can occur and therefore
could be a proxy of effect. With that said, Arceo-Gómez and Ashman
(2016) is the only work which has proven a greater effect of far and
close related pollen with published data with low sample sizes and lack
of significance.
