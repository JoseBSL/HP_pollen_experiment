...
\begin{figure}
\includegraphics[width=1\linewidth]{images/phylo_image} \caption{Phylogenetic tree of the ten species used in the experiment from three different families from bottom to top: Solanaceae, Convolvulaceae and Brassicaceae.}\label{fig:unnamed-chunk-2}
\end{figure}
...
65\% of the pairwise interactions p\textless{}0.05. Moreover, effect
sizes differ across species, see \textbf{Figure 2} where species like
\emph{S. lycopersicum} had a large effect size and other's like \emph{E.
sativa} a small or null effect size.
...
\includegraphics{output/figures/unnamed-chunk-8-3.pdf}
