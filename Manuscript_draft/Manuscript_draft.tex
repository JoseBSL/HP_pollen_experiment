...
style length, number of ovules, incompatibility system and finally a
...
Closely related species are more likely to have similar traits (Refs?
...
transfer networks here such as\ldots{} ). Traditionally, studies have
overlook the effect of closely related species but in a natural context
both can occur and different degree of relatedness should be considered.
