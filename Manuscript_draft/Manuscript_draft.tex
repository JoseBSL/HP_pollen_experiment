...
The effect of heterospecific pollen has been widely studied (refs).
Native species are supposed to have greater negative effects than native
ones Arceo-Gómez and Ashman (2016)

species-specific. What kind of pollen interaction? Size just mechanical?
...
one with 100\% foreign pollen (N=10). The proxy of effect were seed set
and ``pollen tubes''. Moreover, hand cross pollination, hand self
