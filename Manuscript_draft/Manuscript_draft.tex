...
species fitness Arceo-Gómez and Ashman (2016) the effect of
heterospecific pollen of far and close related species remains to be
tested explicitly.
...
task. For this reason, controlled pollination experiments where hand
pollination is applied instead of pollinators as pollen vectors have
simplified this task. However, other issues may arise such as
overestimation of the effect (REFs), standarized methods across studies
or lack of descriptive methodology for reproducible work (REFs). One of
the most common ways to estimate heterospecific pollen effect through
hand pollination treatments is by using 50\% pollen mixes of conspecific
and heterospecific pollen which a realistic proportion (REF) but
challenging because of the different pollen properties such as size or
hydratation levels (REFS).
