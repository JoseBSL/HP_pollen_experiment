...
was counted from one donor of each family (N=3). In order to test the
amount of pollen grains deposited on the stigma with heterospecific
pollinations we counted the total amount of pollen grains and we
calculated the proportions between the two species of the mix. We did
the counts for each species with crosses with one species of the other
two families, therefore 20 different types of mixes with 3 replicates.
