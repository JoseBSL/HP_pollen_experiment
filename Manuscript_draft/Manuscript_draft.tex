...
the help of an stereomicroscope and a small grid over a petri dish from
...
were compared thorugh relevelling each variable with the cross
...
considered as random effects. The changes of seed production across
species were compared through scaling the seed production with mean 0
and standard deviation of 1 prior to the analysis. All the analysis were
conducted with the statistical language \texttt{R} (R Core Team 2018).
...
effect was considered as the subtraction of seed production by hand
cross pollination minus seed production of the different heterospecific
pollen treatments. Moreover, to find a model with the best explanatory
traits we used the function \textbf{bioenv} from R. Finally, we also
conducted mantel test between the matrix of heterospecific pollen effect
and the distance matrix from all the traits. Moreover, We explored also
the relations between traits and heterospecific pollen effect through
...
distances were calculated with MEGA7.
